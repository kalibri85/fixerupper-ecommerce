    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item"><a class="nav-link <?= ($currentPage == 'feedback.php' ? 'active' : '') ?>" href="feedback.php">Feedback</a></li>
          <li class="nav-item"><a class="nav-link <?= ($currentPage == '' ? 'active' : '') ?>" href="orders.php">Orders</a></li>
          <li class="nav-item">
